...
class Charitable_Extension_Activation {
	...
	public function missing_charitable_notice() {
		...
		echo '<div class="error"><p>' . sprintf( _x( '%s requires Charitable! Please %s to continue!', 'Plugin requires Charitable! Please install/activate it to continue!', 'charitable-stripe-connect' ), $this->plugin_name, $link ) . '</p></div>';
	}
}
