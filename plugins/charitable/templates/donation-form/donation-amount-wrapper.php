...
<fieldset class="<?php echo $classes ?>">
	<div class="sub-h colorGreyBlue upper-main-h form-title">Step 1</div>
	<div class="charitable-form-header">Select Donation Amount</div>
	<?php
	...
	<div class="donation-amount-perks"></div>
</fieldset>
