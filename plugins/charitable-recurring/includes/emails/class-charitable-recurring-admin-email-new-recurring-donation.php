 ...
 *
 * @version     1.0.0
 * @package     Charitable_Recurring/Classes/Charitable_Recurring_Admin_Email_New_Recurring_Donation
...
if ( ! class_exists( 'Charitable_Recurring_Admin_Email_New_Recurring_Donation' ) ) : 
 ...
 * @since       1.0.0
 */
class Charitable_Recurring_Admin_Email_New_Recurring_Donation extends Charitable_Email {

    /**
     * @var     string
     */
    CONST ID = 'admin_new_recurring_donation';
    ...
    public function __construct( $objects = array() ) {
        ...
        $this->name = apply_filters( 'charitable_email_name', __( 'Admin: New Recurring Donation Notification', 'charitable-recurring' ), $this );
    }
    ...
    public static function send_with_donation_id( $donation_id ) {
        ...
        $email = new Charitable_Recurring_Admin_Email_New_Recurring_Donation( array( 
            'donation' => $donation
        ) );
    ...
    protected function get_default_subject() {
        return apply_filters( 'charitable_email_default_subject', __( 'You have received a new recurring donation', 'charitable-recurring' ), $this );   
    }
    ...
    protected function get_default_headline() {
        return apply_filters( 'charitable_email_default_headline', __( 'New Recurring Donation', 'charitable-recurring' ), $this );    
    }
    ...
    protected function get_default_body() {
        ob_start();
?>
[charitable_email show=donor] has just made a recurring donation!
