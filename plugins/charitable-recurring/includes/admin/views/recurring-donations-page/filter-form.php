...
<div id="charitable-donations-filter-modal" style="display: none" class="charitable-donations-modal <?php echo esc_attr( $modal_class ) ?>">
	...
	<h3><?php _e( 'Filter Recurring Donations', 'charitable-recurring' ) ?></h3>
	<form class="charitable-donations-modal-form" method="get" action="">
		<input type="hidden" name="post_type" class="post_type_page" value="<?php echo esc_attr( Charitable_Recurring::POST_TYPE );?>"/>
		<fieldset>
			<legend><?php _e( 'Filter by Date', 'charitable-recurring' ) ?></legend>
			<input type="text" id="charitable-filter-start_date" name="start_date" class="charitable-datepicker" value="<?php echo $start_date; ?>" placeholder="<?php esc_attr_e( 'From:', 'charitable-recurring' ) ?>" />
			<input type="text" id="charitable-filter-end_date" name="end_date" class="charitable-datepicker" value="<?php echo $end_date; ?>" placeholder="<?php esc_attr_e( 'To:', 'charitable-recurring' ) ?>" />
		</fieldset>
		<label for="charitable-donations-filter-status"><?php _e( 'Filter by Status', 'charitable-recurring' ) ?></label>
		...
		<label for="charitable-donations-filter-campaign"><?php _e( 'Filter by Campaign', 'charitable-recurring' ) ?></label>
		...
		<button type="submit" class="button button-primary"><?php _e( 'Filter', 'charitable-recurring' ) ?></button>
	</form>
</div>
